...
conflicts under the **merging-main** skill before enabling auto-merge. Use a merge commit and
delete the merged branch. A dependent wait belongs to a background agent, not a polling loop
