...
- Preserve SVGs and raw generated outputs for accepted assets and candidates suggested for human
  review. Keep internal discarded attempts outside the repository; only human-review candidates
  enter the rejected archive. Record extraction commands, tool versions, source dimensions and
