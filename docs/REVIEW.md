...
- **Pace a quiet ordinary sidewalk back and forth for a stretch, then hold its midline through a
  ...
  `CAR_INTENSITY` rose to hold the main road's own price in its place. **Does pacing a quiet route
  sidewalk now read as recovery, closer to how an empty street already did, and do walkers
  stepping out of her way read as polite rather than as a crowd fleeing her?** Record is
  `DECISIONS.md`, M155, the crowd's reach comes in.
