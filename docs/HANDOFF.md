...
The cardinal apartment-street direction is approved, and the grounded modular mother and pram are
bound to the live player from applied displacement without changing collision, movement or gameplay
RNG. Crowd, event, city and screen presentation remain open.
