...
- **The next work is the story's pacing, and it ends in a minor release**
  ...
  day, which needs the places the first two make, and M183, the power station and the blackout,
  whose front door is day 14's task. All four are decided in `TODO.md`
  ([PLAYTEST-118](playtests/PLAYTEST-118.md), [PLAYTEST-119](playtests/PLAYTEST-119.md)). M182, a finished task is shown by the world, has the other tasks' answers open and
