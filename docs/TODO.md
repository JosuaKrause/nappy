...
- [ ] Exchange the displayed SE/SW stroller wheels per PLAYTEST-65, preserving each body, handle,
      canopy and grounded height. Save exact inputs, transformation and paired visual comparison.
