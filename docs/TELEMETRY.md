...
| `ahead` | `EventManager` | Where the director put something from her own walk and where she was standing: a run across her line, or day 3's fire sited or moved on the line she is walking. The only record of a placement no seed reproduces, since it depends on the route she took |
