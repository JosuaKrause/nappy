...
(*"that number was so big because it was a point source before"*). Open to overturn, and the
two constants are the dial: a played verdict that a passing car is too quiet raises
`FIELD_ECCENTRICITY_SPEED`.
