...
copies, as beyond its interpretation of the code-and-assets authorization. Explicit approval
for those documentation updates is requested; the affected active files remain unchanged.
