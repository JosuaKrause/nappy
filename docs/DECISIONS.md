...
`evidence/rig-182605-seed4000-v0.8.2-33-g2b1ee38-dirty/` (day 5, burnt cars) and
`evidence/rig-182622-seed4000-v0.8.2-33-g2b1ee38-dirty/` (day 1, crash). The burnt-car rig loads
...
The corrected captures use the same scenarios: `evidence/rig-183151-seed4000-v0.8.2-33-g2b1ee38-dirty/`
shows the separate crash shadows, and `evidence/rig-183204-seed4000-v0.8.2-33-g2b1ee38-dirty/`
