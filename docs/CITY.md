...
- **A front is district and block purpose, read the same way a roof's furniture is.** Each complete
  two-column span of a `COMMERCIAL` building is a 64×36px storefront — one of four, an awning
  variant on a seeded share — as a plain substitution for the wall's own ground-floor plinth:
