...
| [Supplied stair references](stair-layout-reference-2026-09-10/README.md) | Original generated JPEGs showing lateral switchback flights indoors and along a facade; geometry references with explicit provenance and role. | [PLAYTEST-53](../playtests/PLAYTEST-53.md), sideways switchback stairs |
