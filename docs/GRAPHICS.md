...
| `art/closures/park_post.svg` | The park's upright support and corner joint, 10×24, bottom-center anchor, on `street_kit`. One ground-anchored post joins both axes at each corner; unjoined runs end on the same post. Feet stay on the collision line while the rails meet above them. |
