...
| M100 — Small, real, and nobody's (alley review) | `art/tiles/alley_draft.svg` is a 32×32 paving alternative for comparison and stays prepared and unbound; the live alley tile is unchanged. The chalk mark's own decals are now live — see "City ground and buildings" above. |
