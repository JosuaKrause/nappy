...
The exact tracked SVGs outside the live, prepared and unowned tables are `art/icon_stroller.svg`
and `art/logo.svg`. Neither is loaded by the game or an export resource. They are editable identity
